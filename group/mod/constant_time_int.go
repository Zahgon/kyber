...
func (i *Int) Zero() kyber.Scalar { _ = "STUB: not implemented"; return *new(kyber.Scalar) }

// One sets the Int to the value 1.  The modulus must already be initialized.
func (i *Int) One() kyber.Scalar { _ = "STUB: not implemented"; return *new(kyber.Scalar) }
...
func (i *Int) GroupOrder() *compatiblemod.Mod { _ = "STUB: not implemented"; return nil }
